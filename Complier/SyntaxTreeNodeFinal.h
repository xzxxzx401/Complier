...
inline SyntaxTreeNodeFinal::SyntaxTreeNodeFinal(int type, SyntaxTreeNodeFinalValue val, const int linenum)
	:SyntaxTreeNode(0), value(val), type(type), linenum(linenum)
{
}

inline SyntaxTreeNodeFinal::SyntaxTreeNodeFinal(int type, std::string name, const int linenum)
