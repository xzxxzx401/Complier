...
{
  "$end", "error", "$undefined", "NUMBER", "OP", "PROGRAM", "ID", "';'",
  "'.'", "$accept", "programstruct", "program_head", "program_body", YY_NULL
};
#endif
...
{
       0,   256,   257,   258,   259,   260,   261,    59,    46
};
# endif
